...
import "../styles/tasklist-summary-row-exact.css";

import "../styles/ema-task-detail-delete-button-only.css";
import "../styles/ema-task-list-details-action-fix.css";
          ...
          <section className="settings-content d-grid gap-3 task-list-settings-content">
            ...
            <section className="content-shell task-list-content-shell task-list-settings-table-shell ema-panel-surface">
              ...
              <div className="content-body task-list-content-body settings-task-body">
                ...
                <div className="task-table-utility-row task-summary-row-exact">
                  <div className="task-summary-main-exact">
                    <span>Showing</span>
                  ...
                  <div className="task-summary-status-exact" aria-label="Task quick summary">
                ...
                <div className="user-access-table advanced clean-table task-standard-table">
                  ...
                  {!isLoading && paginatedTasks.map((task, index) => (
                    ...
                    >
                      ...
                      <div className="user-cell">
                        <div className="row-actions user-row-action-wrap clean task-clean-actions task-list-row-actions" onClick={(event) => event.stopPropagation()}>
                          <button
                            type="button"
                            className="task-list-detail-action-btn"
...
function TaskDetailModal({
  ...
  return (
    <div onClick={onClose} role="presentation"><section role="dialog" aria-modal="true" aria-label={`Task ${task.id} detail`} onClick={(event) => event.stopPropagation()}>
