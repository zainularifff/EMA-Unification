...
const [activeModule, setActiveModule] = useState<RestrictionModule>('appBlacklist');
  ...
  return (
    <main className="settings-module-root hardware-module-root ema-settings-pro appwebrestriction-module container-fluid p-3 p-xl-4" data-section="appwebrestriction">
      ...
      <style>{`
        /* APP_RESTRICTION_DUAL_LIST_INLINE_FORCE_START */
        /* Force Package Selection dual-list layout. Loaded inside page so it wins over global table CSS. */

        .ema-appwebrestriction-page-active .arx-dual-section,
        body.ema-appwebrestriction-page-active .arx-dual-section,
        main .arx-dual-section {
        ...
        .ema-appwebrestriction-page-active .arx-dual-section > div:first-child,
        body.ema-appwebrestriction-page-active .arx-dual-section > div:first-child,
        main .arx-dual-section > div:first-child {
          display: grid !important;
        ...
        .ema-appwebrestriction-page-active .arx-dual-section h4,
        body.ema-appwebrestriction-page-active .arx-dual-section h4,
        main .arx-dual-section h4 {
          margin: 0 !important;
        ...
        .ema-appwebrestriction-page-active .arx-dual-section p,
        body.ema-appwebrestriction-page-active .arx-dual-section p,
        main .arx-dual-section p {
        ...
        .ema-appwebrestriction-page-active .arx-dual-search,
        body.ema-appwebrestriction-page-active .arx-dual-search,
        main .arx-dual-search {
          width: 100% !important;
        ...
        .ema-appwebrestriction-page-active .arx-dual-search input,
        body.ema-appwebrestriction-page-active .arx-dual-search input,
        main .arx-dual-search input {
          width: 100% !important;
          min-width: 0 !important;
          border: 0 !important;
          outline: 0 !important;
        ...
        .ema-appwebrestriction-page-active .arx-dual-grid,
        body.ema-appwebrestriction-page-active .arx-dual-grid,
        main .arx-dual-grid {
          display: grid !important;
        ...
        .ema-appwebrestriction-page-active .arx-dual-col,
        body.ema-appwebrestriction-page-active .arx-dual-col,
        main .arx-dual-col {
          display: block !important;
          width: 100% !important;
          min-width: 0 !important;
        ...
        .ema-appwebrestriction-page-active .arx-dual-grid > div:nth-child(2),
        body.ema-appwebrestriction-page-active .arx-dual-grid > div:nth-child(2),
        main .arx-dual-grid > div:nth-child(2) {
          display: flex !important;
          align-items: center !important;
          justify-content: center !important;
        ...
        .ema-appwebrestriction-page-active .arx-dual-grid > div:nth-child(2) > div,
        body.ema-appwebrestriction-page-active .arx-dual-grid > div:nth-child(2) > div,
        main .arx-dual-grid > div:nth-child(2) > div {
        ...
        .ema-appwebrestriction-page-active .arx-list-panel,
        body.ema-appwebrestriction-page-active .arx-list-panel,
        main .arx-list-panel {
          display: flex !important;
          flex-direction: column !important;
          width: 100% !important;
        ...
        .ema-appwebrestriction-page-active .arx-list-head,
        body.ema-appwebrestriction-page-active .arx-list-head,
        main .arx-list-head {
          flex: 0 0 auto !important;
          width: 100% !important;
        ...
        .ema-appwebrestriction-page-active .arx-list-body,
        body.ema-appwebrestriction-page-active .arx-list-body,
        main .arx-list-body {
          flex: 1 1 auto !important;
          display: block !important;
          width: 100% !important;
        ...
        .ema-appwebrestriction-page-active .arx-list-row,
        body.ema-appwebrestriction-page-active .arx-list-row,
        main .arx-list-row {
          display: grid !important;
        ...
        .ema-appwebrestriction-page-active .arx-list-row + .arx-list-row,
        body.ema-appwebrestriction-page-active .arx-list-row + .arx-list-row,
        main .arx-list-row + .arx-list-row {
          margin-top: 0.35rem !important;
        }

        .ema-appwebrestriction-page-active .arx-list-row > div:first-child,
        body.ema-appwebrestriction-page-active .arx-list-row > div:first-child,
        main .arx-list-row > div:first-child {
          display: flex !important;
          flex-direction: row !important;
          align-items: center !important;
          gap: 0.55rem !important;
        ...
        .ema-appwebrestriction-page-active .arx-list-row > div:first-child > span:first-child,
        body.ema-appwebrestriction-page-active .arx-list-row > div:first-child > span:first-child,
        main .arx-list-row > div:first-child > span:first-child {
        ...
        .ema-appwebrestriction-page-active .arx-list-row > div:first-child > span:last-child,
        body.ema-appwebrestriction-page-active .arx-list-row > div:first-child > span:last-child,
        main .arx-list-row > div:first-child > span:last-child {
          display: block !important;
          min-width: 0 !important;
          max-width: 100% !important;
        }

        .ema-appwebrestriction-page-active .arx-list-row strong,
        .ema-appwebrestriction-page-active .arx-list-row small,
        body.ema-appwebrestriction-page-active .arx-list-row strong,
        body.ema-appwebrestriction-page-active .arx-list-row small,
        main .arx-list-row strong,
        main .arx-list-row small {
          display: block !important;
          max-width: 100% !important;
          white-space: nowrap !important;
          overflow: hidden !important;
        ...
        .ema-appwebrestriction-page-active .arx-list-row > div:last-child,
        body.ema-appwebrestriction-page-active .arx-list-row > div:last-child,
        main .arx-list-row > div:last-child {
        ...
        .ema-appwebrestriction-page-active .arx-list-row button,
        body.ema-appwebrestriction-page-active .arx-list-row button,
        main .arx-list-row button {
        ...
        .ema-appwebrestriction-page-active .arx-list-panel > div:last-child,
        body.ema-appwebrestriction-page-active .arx-list-panel > div:last-child,
        main .arx-list-panel > div:last-child {
          flex: 0 0 auto !important;
          width: 100% !important;
          min-height: 44px !important;
          display: flex !important;
        ...
        /* APP_RESTRICTION_DUAL_LIST_INLINE_FORCE_END */
      `}</style>
  ...
  function renderPackageSelector() {
    return (
      <div className="arx-package-selection-scope">
        <DualListSection
