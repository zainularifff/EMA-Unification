...
async function handleAiAssistRequest(req, res) {
...
function registerAiAssistRoutes(app) {
  const jsonParser = express.json({ limit: '1mb' });

  app.post('/api/ai-assist', jsonParser, handleAiAssistRequest);
  app.post('/api/ai/assist', jsonParser, handleAiAssistRequest);
  app.post('/api/assistant/chat', jsonParser, handleAiAssistRequest);
}
