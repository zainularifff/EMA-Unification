...
export default function HardwareInventory() {
  ...
  return (
    <div className={`hardware-inventory-page ema-grid-page ${hasSelectedDevice ? "has-selected-device" : "no-selected-device"}`}>
      <section className="hardware-left-panel ema-grid-sidebar ema-sidebar-panel ema-command-panel hardware-command-panel">
        <div className="hardware-panel-head ema-sidebar-brand ema-command-card">
          <div>
            <span>Hardware Command Center</span>
            <h3>Hardware Inventory</h3>
            <p>Endpoint hierarchy and synchronized device records.</p>
          </div>
        </div>
      ...
      <section className="ema-grid-top ema-kpi-grid cols-5">
          {kpiCards.map((card) => (
            <button
              key={card.key}
              type="button"
      ...
      <main className="hardware-card hardware-registry-card ema-grid-content">
      ...
      <aside ref={hardwareQuickPanelRef} className="hardware-card hardware-right-panel ema-grid-inspector">
