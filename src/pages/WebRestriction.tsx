          ...
          <div>
            ...
            <main>
              ...
              <div>
                ...
                {editingWebGroup && (
                  <button type="button" onClick={() => deleteWebGroup(editingWebGroup)} disabled={loading}>
            ...
            <aside>
              ...
              <div>
                {filteredPackageManagerRows.length === 0 ? (
                  ...
                  return (
                    <button key={id} type="button" onClick={() => selectManagerPackage(item)}>
                      <div>
                        <div>
            ...
            <main>
              ...
              <div>
                ...
                {selectedManagerPackage && (
                  <button type="button" onClick={() => deleteManagerPackage(selectedManagerPackage)} disabled={packageManagerLoading}>
