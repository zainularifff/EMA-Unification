...
const sidebarStyles = {
  ...
  tabs: "grid gap-2",
  tabBase:
    "flex w-full items-start gap-3 rounded-lg border px-3 py-2 text-left transition focus:outline-none focus:ring-2 focus:ring-blue-100",
  tabActive: "border-blue-200 bg-blue-50 text-blue-950 shadow-sm",
  tabIdle: "border-transparent bg-white text-slate-700 hover:border-slate-200 hover:bg-slate-50",
  tabIcon: "mt-0.5 grid h-6 w-6 shrink-0 place-items-center rounded-md",
  tabIconActive: "bg-white text-blue-600",
  tabIconIdle: "bg-slate-50 text-slate-500",
  tabText: "min-w-0 leading-none",
  tabTitle: "block text-xs font-black leading-4 text-slate-950",
  tabDesc: "mt-0.5 block text-[0.68rem] font-semibold leading-4 text-slate-500",
  searchWrap:
